...
int main(){
    ...
    printf("valor da primeira carta: %d, valor da segunda carta: %f\n", Populacao1, Populacao2);
    ...
    printf("valor da primeira carta: %d, valor da segunda carta: %d\n", Populacao1, Populacao2);
    printf("valor da primeira carta: %f, valor da segunda carta: %d\n", PibPerCapita1, PibPerCapita2);
    ...
    if(AreaEmKm1 > AreaEmKm2){
        ...
        printf("valor da primeira carta: %f, valor da segunda carta: %f", AreaEmKm1, AreaEmKm2);
        printf("valor da primeira carta: %d, valor da segunda carta: %d", DensidadePopulacional1, DensidadePopulacional2);
        ...
        else if(SuperPoder2 > super SuperPoder1){
            printf("carta 2 ganhou\n");
        } else if(AreaEmKm2 > AreaEmKm1){
            printf("carta 2 ganhou\n");
        }else{
        ...
        printf("valor da primeira carta: %f, valor da segunda carta: %f", AreaEmKm1, AreaEmKm2);
        printf("valor da primeira carta: %d, valor da segunda carta: %d", PibPerCapita1, PibPerCapita2);
